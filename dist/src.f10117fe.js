...
function checkWinner() {
  ...
  for (var _i = 0; _i < ROW_COUNT; _i++) {
    if (boardState[_i][0] !== "" && boardState[_i][0] === boardState[_i][1] && boardState[_i][1] === boardState[_i][2]) {
      return boardState[_i][0];
    }
  }

  for (var _i2 = 0; _i2 < COL_COUNT; _i2++) {
    if (boardState[0][_i2] !== "" && boardState[0][_i2] === boardState[1][_i2] && boardState[1][_i2] === boardState[2][_i2]) {
      return boardState[0][_i2];
    }
  }
